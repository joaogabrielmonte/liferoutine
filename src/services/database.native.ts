  ...
  try {
    ...
    if ((countRow?.count ?? 0) === 0) {
      await db.execAsync(`
        ...
        VALUES 
          ('1', 'Beber agua', 'Meta de 8 copos por dia', 'water-outline', '#06B6D4', 'health', 'daily', '[0,1,2,3,4,5,6]', 8, 'copos', 0, '${now}', '${now}', 0, 0),
          ('2', 'Exercitar', 'Meta de 30 min de treino', 'dumbbell', '#F59E0B', 'fitness', 'daily', '[0,1,2,3,4,5,6]', 30, 'min', 0, '${now}', '${now}', 0, 0),
          ('3', 'Meditar', '10 min de meditacao', 'brain', '#8B5CF6', 'mindfulness', 'daily', '[0,1,2,3,4,5,6]', 1, 'vez', 0, '${now}', '${now}', 0, 0),
          ('4', 'Ler', 'Meta de 20 paginas', 'book-open-outline', '#22C55E', 'learning', 'daily', '[0,1,2,3,4,5,6]', 20, 'paginas', 0, '${now}', '${now}', 0, 0);
      `);
    }
  } catch (err) {
